...
import { selectIncontextGameStratergyExamples } from "@/app/store/redux/pageSlice"
import { setIncontextExample, selectIncontextExample } from "@/app/store/redux/chatSlice"
import { IncontextExample } from '@/app/types';

const GameStratergyMode: FC = () => {
    const dispatch = useAppDispatch();
    const incontextStratergyExamples = useAppSelector(selectIncontextGameStratergyExamples);
...
export default GameStratergyMode;