...
import { editPrompt, editUser, selectPrompts } from "@/app/store/redux/pageSlice";
...
const EditPrompt: FC<Props> = (props) => {
    const { open, setOpen, promptId } = props;
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, actions) => {
            ...
            const res = await dispatch(editPrompt(values, promptId));
