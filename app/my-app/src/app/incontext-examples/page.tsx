...
import AddIncontextExample from "@/app/components/incontextExamples/AddIncontextExample";
import EditIncontextExample from "@/app/components/incontextExamples/EditIncontextExample";
import { useAppSelector, useAppDispatch } from "@/app/store/hooks";
import { selectLoading, selectIncontextExamples, getAllIncontextExamples, deleteIncontextExample } from "@/app/store/redux/pageSlice"
                                            ...
                                            {incontextExamples.map((example, idx) => (
                                                <tr key={idx}>
                                                    ...
                                                    <td className="relative py-4 pr-4 pl-3 text-right text-sm font-medium whitespace-nowrap sm:pr-6">
                                                        <span onClick={() => setEditOpen(example._id)} className="cursor-pointer text-indigo-600 hover:text-indigo-900 mr-2">
                                                            Edit
                                                        </span>
