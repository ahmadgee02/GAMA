...
import ErrMsg from "@/components/common/form/ErrMsg";
...
const PromptForm: FC<Props> = (props) => {
    const { formik, onClose, type } = props;
            ...
            <form onSubmit={handleSubmit}>
                <div className="space-y-12">
                    <div className="border-b border-white/10 pb-8">
                        <h2 className="text-base/7 font-semibold text-white">Add { type }</h2>
